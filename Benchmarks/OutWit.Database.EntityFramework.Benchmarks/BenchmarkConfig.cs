...
/// <summary>
/// Base configuration for EF Core benchmarks.
/// </summary>
public class EfCoreBenchmarkConfig : ManualConfig
{
    public EfCoreBenchmarkConfig()
    {
...
/// <summary>
/// EF Core provider type for benchmarking.
/// WitDb and LiteDB are both pure managed .NET implementations.
/// SQLite is a native C library with .NET bindings.
/// </summary>
public enum EfProviderType
{
    /// <summary>Pure managed .NET embedded database with EF Core provider</summary>
    WitDb,
    
    /// <summary>Native C library with EF Core provider (baseline for speed)</summary>
    SQLite,
    
    /// <summary>Pure managed .NET NoSQL database (baseline for managed memory, no EF)</summary>
    LiteDB
}
