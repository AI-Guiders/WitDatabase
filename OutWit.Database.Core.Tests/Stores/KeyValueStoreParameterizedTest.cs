...
/// Uses TestCaseSource to run each test with both MemoryStorage and FileStorage.
/// </summary>
[TestFixture]
public class KeyValueStoreParameterizedTest
{
    #region Basic CRUD

    [Test]
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    public void Put_And_Get_Works(IStorageFactory factory)
    {
        using (factory)
        {
    ...
    [Test]
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    public void Get_NonExistent_ReturnsNull(IStorageFactory factory)
    {
        using (factory)
        {
            using var store = factory.CreateStore();
    ...
    [Test]
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    public void Put_Updates_ExistingKey(IStorageFactory factory)
    {
        using (factory)
        {
            using var store = factory.CreateStore();
    ...
    [Test]
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    public void Delete_ExistingKey_Succeeds(IStorageFactory factory)
    {
        using (factory)
        {
            using var store = factory.CreateStore();
    ...
    [Test]
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    public void Delete_NonExistent_ReturnsFalse(IStorageFactory factory)
    {
        using (factory)
        {
            using var store = factory.CreateStore();
    ...
    [Test]
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    public void Scan_All_ReturnsInOrder(IStorageFactory factory)
    {
        using (factory)
        {
            using var store = factory.CreateStore();
    ...
    [Test]
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    public void Scan_WithRange_ReturnsCorrectSubset(IStorageFactory factory)
    {
        using (factory)
        {
            using var store = factory.CreateStore();
    ...
    [Test]
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    public void Scan_Empty_ReturnsEmpty(IStorageFactory factory)
    {
        using (factory)
        {
            using var store = factory.CreateStore();
    ...
    [Test]
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    public void BulkInsert_AllRetrievable(IStorageFactory factory)
    {
        using (factory)
        {
            using var store = factory.CreateStore();
    ...
    [Test]
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    public void InsertDelete_MixedOperations(IStorageFactory factory)
    {
        using (factory)
        {
            using var store = factory.CreateStore();
    ...
    [Test]
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    public async Task Async_PutGetDelete_Works(IStorageFactory factory)
    {
        using (factory)
        {
            using var store = factory.CreateStore();
    ...
    [Test]
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    public async Task ScanAsync_Works(IStorageFactory factory)
    {
        using (factory)
        {
            using var store = factory.CreateStore();
    ...
    [Test]
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    public void BinaryKeys_WithNullBytes_Work(IStorageFactory factory)
    {
        using (factory)
        {
            using var store = factory.CreateStore();
    ...
    [Test]
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    public void EmptyValue_Works(IStorageFactory factory)
    {
        using (factory)
        {
            using var store = factory.CreateStore();
    ...
    [Test]
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    public void LargeKey_Works(IStorageFactory factory)
    {
        using (factory)
        {
            using var store = factory.CreateStore();
    ...
    [TestCaseSource(typeof(StorageFactorySource), nameof(StorageFactorySource.AllStorages))]
    [Category("Stress")]
    public void RandomOperations_MaintainsConsistency(IStorageFactory factory)
    {
        using (factory)
        {
            using var store = factory.CreateStore();
