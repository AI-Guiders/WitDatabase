...
namespace OutWit.Database.Core.Tests.Benchmarks.Storage
{
    ...
    public class StorageBenchmarkTest
    {
        ...
        public void SetUp()
        {
            m_testDir = Path.Combine(Path.GetTempPath(), $"WitDB_Benchmark_{Guid.NewGuid():N}");
        ...
        public void FileStorageRandomReadBenchmark(int pageCount, int operationCount)
        {
            ...
            string filePath = Path.Combine(m_testDir, $"read_benchmark_{pageCount}.wdb");
        ...
        {
            const int pageSize = 4096;
            string filePath = Path.Combine(m_testDir, $"write_benchmark_{pageCount}.wdb");
        ...
        public void FileStorageMixedReadWriteBenchmark(int pageCount, int operationCount)
        {
            ...
            string filePath = Path.Combine(m_testDir, $"mixed_benchmark_{pageCount}.wdb");
        ...
        public void MemoryStorageVsFileStorageComparison()
        {
            ...
            string filePath = Path.Combine(m_testDir, "comparison.wdb");
