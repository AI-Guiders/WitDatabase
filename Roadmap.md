...
|-----------|----------------|-------------|---------|----------|
| **OutWit.Database.Core** | 64 | 19 | 45 | 30% |
| **OutWit.Database.Parser** | 282 | 242 | 40 | 86% |
| **OutWit.Database** (Engine) | 350+ | 0 | 350+ | 0% |
...
| `CONSTRAINT name ...` | N/A | [ ] | [ ] | SS13.3 |
| Computed columns `AS (expr)` | N/A | [ ] | [ ] | SS20 |
| `STORED` / `VIRTUAL` modifiers | N/A | [ ] | [ ] | SS20 |
...
| `ALTER TABLE ... DROP CONSTRAINT` | N/A | [ ] | [ ] | SS13.3 |
...
| `INSERT OR REPLACE` | N/A | [ ] | [ ] | SS16.1 |
| `INSERT ... ON CONFLICT DO UPDATE` | N/A | [ ] | [ ] | SS16.2 |
| `INSERT ... ON CONFLICT DO NOTHING` | N/A | [ ] | [ ] | SS16.2 |
| `EXCLUDED.column` reference | N/A | [ ] | [ ] | SS16 |
...
| `UPDATE ... FROM other_table` | N/A | [ ] | [ ] | SS17.2 |
...
| `DELETE ... USING other_table` | N/A | [ ] | [ ] | SS17.3 |
...
| `MERGE INTO target USING source ON` | N/A | [ ] | [ ] | SS16.3 |
| `WHEN MATCHED THEN UPDATE` | N/A | [ ] | [ ] | SS16.3 |
| `WHEN NOT MATCHED THEN INSERT` | N/A | [ ] | [ ] | SS16.3 |
...
| `expression > ANY (subquery)` | N/A | [ ] | [ ] | SS18.2 |
| `expression > SOME (subquery)` | N/A | [ ] | [ ] | SS18.2 |
| `expression > ALL (subquery)` | N/A | [ ] | [ ] | SS18.2 |
...
| Feature | Core | Parser | Engine | Spec |
|---------|------|--------|--------|------|
| `COLLATE collation_name` in column | N/A | [ ] | [ ] | SS24 |
| `COLLATE` in expression | N/A | [ ] | [ ] | SS24 |
| `COLLATE` in ORDER BY | N/A | [ ] | [ ] | SS24 |
| `BINARY`, `NOCASE`, `UNICODE`, `UNICODE_CI` | N/A | [ ] | [ ] | SS24 |
...
| `LEFT(str, n)` | N/A | [ ] | [ ] | SS5.2 |
| `RIGHT(str, n)` | N/A | [ ] | [ ] | SS5.2 |
...
| Function | Core | Parser | Engine | Spec |
|----------|------|--------|--------|------|
| `JSON_VALUE`, `JSON_QUERY`, `JSON_EXTRACT` | N/A | [ ] | [ ] | SS21.2 |
| `JSON_SET`, `JSON_INSERT`, `JSON_REPLACE` | N/A | [ ] | [ ] | SS21.2 |
| `JSON_REMOVE`, `JSON_TYPE`, `JSON_VALID` | N/A | [ ] | [ ] | SS21.2 |
| `JSON_ARRAY`, `JSON_OBJECT` | N/A | [ ] | [ ] | SS21.2 |

---

# Part 5: Window Functions, Transactions, Advanced
...
| `READ UNCOMMITTED/COMMITTED` | [ ] | [ ] | [ ] | SS14.1 |
| `REPEATABLE READ` / `SERIALIZABLE` | [ ] | [ ] | [ ] | SS14.1 |
| `SNAPSHOT` | [ ] | [ ] | [ ] | SS14.1 |

## 31. User-Defined Functions (SS22)

| Feature | Core | Parser | Engine | Spec |
|---------|------|--------|--------|------|
| `CREATE FUNCTION ... RETURNS ... AS BEGIN END` | N/A | [ ] | [ ] | SS22.1 |
| `RETURNS TABLE (...)` | N/A | [ ] | [ ] | SS22.2 |
| `DETERMINISTIC` modifier | N/A | [ ] | [ ] | SS22.1 |
| `DROP FUNCTION [IF EXISTS]` | N/A | [ ] | [ ] | SS22 |

## 32. Stored Procedures (SS23)

| Feature | Core | Parser | Engine | Spec |
|---------|------|--------|--------|------|
| `CREATE PROCEDURE ... AS BEGIN END` | N/A | [ ] | [ ] | SS23 |
| `DROP PROCEDURE [IF EXISTS]` | N/A | [ ] | [ ] | SS23 |
| `CALL procedure(args)` | N/A | [ ] | [ ] | SS23 |
| `EXECUTE procedure(args)` | N/A | [ ] | [ ] | SS23 |

## 33. EXPLAIN (SS25)

| Feature | Core | Parser | Engine | Spec |
|---------|------|--------|--------|------|
| `EXPLAIN select_statement` | N/A | [ ] | [ ] | SS25.1 |
| `EXPLAIN ANALYZE` | N/A | [ ] | [ ] | SS25.1 |
| `EXPLAIN (FORMAT JSON/TEXT)` | N/A | [ ] | [ ] | SS25.1 |

## 34. Database Administration (SS26)

| Feature | Core | Parser | Engine | Spec |
|---------|------|--------|--------|------|
| `CREATE DATABASE` | N/A | [ ] | [ ] | SS26.1 |
| `DROP DATABASE [IF EXISTS]` | N/A | [ ] | [ ] | SS26.1 |
| `ATTACH DATABASE 'path' AS alias` | N/A | [ ] | [ ] | SS26.1 |
| `DETACH DATABASE alias` | N/A | [ ] | [ ] | SS26.1 |
| `VACUUM [table_name]` | [ ] | [ ] | [ ] | SS26.2 |
| `ANALYZE [table_name]` | [ ] | [ ] | [ ] | SS26.2 |
| `PRAGMA name [= value]` | N/A | [ ] | [ ] | SS26.3 |

## 35. INFORMATION_SCHEMA (SS13.1)
...
## 38. Missing Core Components

| Feature | Core | Priority | TODO Ref |
|---------|------|----------|----------|
| `IsolationLevel` enum | [ ] | P0 | SS1.1 |
| MVCC implementation | [ ] | P0 | SS1.2 |
| Transaction isolation level | [ ] | P0 | SS1.3 |
| Record versioning | [ ] | P0 | SS1.4 |
| `RowLockManager` | [ ] | P0 | SS2.1 |
| `FOR UPDATE` / `FOR SHARE` | [ ] | P0 | SS2.2 |
| `NOWAIT` / `SKIP LOCKED` | [ ] | P1 | SS2.3 |
| Deadlock detection | [ ] | P0 | SS2.4 |
| `CreateSavepoint(name)` | [ ] | P1 | SS3.1 |
| `RollbackToSavepoint(name)` | [ ] | P1 | SS3.2 |
| `ReleaseSavepoint(name)` | [ ] | P1 | SS3.3 |
| Nested savepoints | [ ] | P1 | SS3.4 |
| `IMultiResultReader` | [ ] | P1 | SS4.1 |
| `NextResult()` | [ ] | P1 | SS4.2 |
| Batch execution | [ ] | P1 | SS4.3 |
| `ICursor` interface | [ ] | P2 | SS5.1 |
| Scrollable cursors | [ ] | P2 | SS5.2 |
| Fetch size | [ ] | P2 | SS5.3 |
| `IQueryContext` | [ ] | P0 | SS6.1 |
| `AffectedRows` | [ ] | P0 | SS6.2 |
| `LastInsertId` | [ ] | P0 | SS6.3 |
| Query timeout | [ ] | P0 | SS6.4 |
| `CancellationToken` | [ ] | P0 | SS6.5 |
| `ISecondaryIndex` | [ ] | P0 | SS7.1 |
| B+Tree secondary indexes | [ ] | P0 | SS7.2 |
| Unique index support | [ ] | P0 | SS7.3 |
| Composite index support | [ ] | P0 | SS7.4 |
| Index auto-update | [ ] | P0 | SS7.5 |
| `BulkPut()` | [ ] | P1 | SS8.1 |
| `BulkDelete()` | [ ] | P1 | SS8.2 |
| Streaming insert | [ ] | P1 | SS8.3 |
| Table row count | [ ] | P1 | SS9.1 |
| Index statistics | [ ] | P1 | SS9.2 |
| `ANALYZE` support | [ ] | P2 | SS9.3 |
| Cardinality estimation | [ ] | P2 | SS9.4 |
| `Vacuum()` method | [ ] | P2 | SS10.1 |
| Incremental vacuum | [ ] | P2 | SS10.2 |
| Compaction status API | [ ] | P2 | SS10.3 |
| Concurrent read transactions | [ ] | P0 | SS11.1 |
| Read during write (MVCC) | [ ] | P0 | SS11.2 |
| Transaction wait queue | [ ] | P0 | SS11.3 |
| ROWVERSION auto-increment | [ ] | P1 | SS12.1 |
| Optimistic concurrency | [ ] | P1 | SS12.2 |
| Conditional Put/Delete | [ ] | P1 | SS12.3 |

---

# Implementation Priorities

## Phase 1: MVP for ADO.NET (2-3 weeks)
...
### Core Tasks
- [ ] `IQueryContext` with AffectedRows, LastInsertId
- [ ] Query timeout and CancellationToken
- [ ] `ISecondaryIndex` interface
- [ ] B+Tree secondary indexes
- [ ] Unique/Composite index support
- [ ] Savepoints implementation

## Phase 2: EF Core Compatibility (4-6 weeks)
...
### Core Tasks
- [ ] Isolation levels enum and implementation
- [ ] MVCC (Multi-Version Concurrency Control)
- [ ] Row-level locking with `RowLockManager`
- [ ] Deadlock detection
...
### Core Tasks
- [ ] `IMultiResultReader` for batch queries
- [ ] Bulk operations
- [ ] Statistics and query optimizer hints
...
| `OutWit.Database.Parser.TODO.md` | Parser TODO list |
